...
class CpuBenchmarkActivity : AppCompatActivity() {
    ...
    override fun onStart() {
        ...
        cpu_filter.setOnClickListener {
            ...
            if (order == "inc") {
                mDialogView.inc_filter.isChecked = true
                intent.putExtra("order", "inc")
            } else if (order == "deinc") {
                mDialogView.deinc_filter.isChecked = true
                intent.putExtra("order", "deinc")
            }
            ...
            mDialogView.inc_filter.setOnClickListener {
                intent.putExtra("order", "inc")
                mDialogView.deinc_filter.isChecked = false
            }

            mDialogView.deinc_filter.setOnClickListener {
                intent.putExtra("order", "deinc")
                mDialogView.inc_filter.isChecked = false
            }
            ...
            mDialogView.button_filter.setOnClickListener {
                ...
                if(!mDialogView.inc_filter.isChecked && !mDialogView.deinc_filter.isChecked) {
                    intent.putExtra("order", "inc")
                }
